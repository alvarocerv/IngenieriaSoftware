...
class TestSeparacionDatos:
    ...
    def test_separacion_80_20(self, datos_completos):
        ...
        train_df, test_df = train_test_split(datos_completos, test_size=0.2, random_state=42)
    ...
    def test_separacion_70_30(self, datos_completos):
        ...
        train_df, test_df = train_test_split(datos_completos, test_size=0.3, random_state=42)
    ...
    def test_proporcion_minima(self, datos_completos):
        ...
        train_df, test_df = train_test_split(datos_completos, test_size=0.9, random_state=42)
    ...
    def test_proporcion_maxima(self, datos_completos):
        ...
        train_df, test_df = train_test_split(datos_completos, test_size=0.01, random_state=42)
    ...
    def test_datos_pequeños(self):
        ...
        train_df, test_df = train_test_split(datos_pequeños, test_size=0.4, random_state=42)
...
class TestSeleccionColumnas:
    ...
    def test_columna_no_existe(self, datos_muestra):
        ...
        try:
            resultado = datos_muestra[['columna_inexistente']]
