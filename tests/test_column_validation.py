...
class TestColumnValidation:
    ...
    def test_columnas_con_nulos_validas(self):
        ...
        for col in df.columns:
            ...
            assert es_numerica, f"La columna {col} debería ser numérica (ignorando nulos)"
    ...
    def test_columnas_con_texto_invalidas(self):
        ...
        assert 'nombre' in columnas_no_numericas, "La columna 'nombre' debería ser no numérica"
        assert 'ciudad' in columnas_no_numericas, "La columna 'ciudad' debería ser no numérica"
        assert 'edad' not in columnas_no_numericas, "La columna 'edad' debería ser numérica"
    ...
    def test_columnas_mixtas_invalidas(self):
        ...
        assert 'datos_mixtos' in columnas_no_numericas, "La columna 'datos_mixtos' debería ser no numérica"
        assert 'numeros' not in columnas_no_numericas, "La columna 'numeros' debería ser numérica"
    ...
    def test_columnas_string_numericos_validas(self):
        ...
        for col in df.columns:
            ...
            assert es_numerica, f"La columna {col} con strings numéricos debería ser convertible"
