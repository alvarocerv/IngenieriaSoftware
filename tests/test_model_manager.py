...
class TestGuardadoRecuperacionModelo:
    ...
    def test_guardar_modelo_json(self, modelo_entrenado, directorio_temporal):
        ...
        formula = f"{modelo_entrenado['columna_salida']} = " + " + ".join(
            [f"({coef:.6f}*{col})" for coef, col in 
             zip(modelo.coef_, modelo_entrenado['columnas_entrada'])]
    ...
    def test_cargar_modelo_json(self, modelo_entrenado, directorio_temporal):
        ...
        assert modelo_cargado['entradas'] == modelo_entrenado['columnas_entrada']
        np.testing.assert_array_almost_equal(
            modelo_cargado['coeficientes'],
            modelo.coef_
        )
    
    def test_guardar_modelo_joblib(self, modelo_entrenado, directorio_temporal):
    ...
    def test_guardar_modelo_pickle(self, modelo_entrenado, directorio_temporal):
    ...
    def test_prediccion_modelo_recuperado(self, modelo_entrenado, directorio_temporal):
    ...
    def test_validar_campos_requeridos(self, modelo_entrenado, directorio_temporal):
